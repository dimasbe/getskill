...
const SkeletonBanner: React.FC = () => {
  return (
    <section className="relative bg-white overflow-hidden">
      {/* Dot pattern kiri */}
      <div className="absolute top-0 left-0 w-32 h-32 bg-gray-200 rounded-full opacity-20 -translate-x-10 -translate-y-10" />
      {/* Dot pattern kanan */}
      <div className="absolute bottom-0 right-0 w-32 h-32 bg-gray-200 rounded-full opacity-20 translate-x-10 translate-y-10" />

      <div className="relative z-10 px-6 py-20">
        <div className="text-center mx-auto max-w-3xl space-y-4">
          {/* Skeleton subtitle */}
          <div className="mx-auto bg-gray-300/60 h-5 w-64 animate-pulse rounded"></div>

          {/* Skeleton title */}
          <div className="mx-auto bg-gray-300/60 h-7 w-3/4 animate-pulse rounded"></div>
          <div className="mx-auto bg-gray-200/60 h-6 w-5/6 animate-pulse rounded"></div>
          <div className="mx-auto bg-gray-200/60 h-6 w-2/3 animate-pulse rounded"></div>
        </div>
      </div>
    </section>
  );
