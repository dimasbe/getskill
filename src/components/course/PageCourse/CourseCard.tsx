...
export default function CourseCard({ course }: CourseCard) {
  ...
  const coursePhoto = course.photo && course.photo.trim() !== "" ? course.photo : defaultPhoto;
    ...
    >
      ...
      <div className="flex-1 px-4 py-3 text-left flex flex-col">
        ...
        <div className="flex items-center justify-between mb-3">
          <span className="bg-gray-100 font-semibold font-sans text-gray-800  text-[10px] px-2 py-1 rounded-full leading-none transition-all duration-300 ease-in-out  hover:bg-purple-700 hover:text-white hover:shadow-md">
        ...
        <div className="min-h-[55px] mb-2">
          <h3 className="text-[15px] font-medium line-clamp-2 min-h-[30px]">
            <a className="inline bg-[linear-gradient(gray,gray),linear-gradient(gray,gray)]
