    ...
    <section className="relative bg-gradient-to-br from-white via-[#faf9fb] to-[#ebe9f0] overflow-hidden min-h-[55vh] md:min-h-[40vh] lg:min-h-[90vh] xl:min-h-[80vh] 2xl:min-h-[85vh] m-0 pt-0">
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-6 md:px-20 lg:px-10 xl:px-22 2xl:px-34 pt-10 md:pt-16 relative z-10">
        ...
        <div className="w-1/2 md:w-1/2 lg:w-3/4 relative flex justify-center items-center">
          ...
          {/* Panah ungu */}
          <img src={arrowPattern} alt="Panah Ungu" className="absolute -right-[10px] md:-right-[30px] lg:right-[6px] xl:right-[35px] 2xl:right-[50px] top-[60px] md:top-[150px] lg:top-[220px] xl:top-[250px] 2xl:top-[300px] w-[330px] md:w-[320px] lg:w-[460px] xl:w-[490px] 2xl:w-[570px] z-0 " data-aos="fade-up" />
