            ...
            <div className="max-w-7xl mx-auto px-4 xl:px-10 lg:px-20 md:px-30 sm:px-20 py-10 md:py-18" >
                ...
                {isOpen && (
                        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70" >
                            <div className="relative bg-transparent rounded-lg max-w-2xl w-auto" >
                                {/* tombol close */}
                                < button
                                    onClick={() => setIsOpen(false)
                                    }
                                    className="absolute -top-8 right-0 text-white hover:text-gray-300 text-3xl"
                                >
                                    & times;
                                </button>
                                ...
                                <img
                                    src={event.image}
                                    alt={event.title}
                                    className="w-auto max-w-full max-h-[90vh] object-contain rounded-lg"
                                />
                            </div>
                        </div>
                    )}
